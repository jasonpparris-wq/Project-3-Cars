...
def main():
    ...
    mlflow.sklearn.log_model(
        sk_model=model,
        registered_model_name="price_prediction_model",  # Specify the name under which the model will be registered
        artifact_path="random_forest_price_prediction"  # Specify the path where the model artifacts will be stored
    )
